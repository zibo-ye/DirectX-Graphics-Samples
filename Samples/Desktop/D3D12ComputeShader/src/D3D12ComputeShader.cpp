...
const float D3D12ComputeShader::ParticleSpread = 400.0f;

D3D12ComputeShader::D3D12ComputeShader(UINT width, UINT height, std::wstring name) :
...
void D3D12ComputeShader::OnInit()
{
...
void D3D12ComputeShader::LoadPipeline()
{
...
void D3D12ComputeShader::LoadAssets()
{
    ...
    // Create the pipeline states, which includes compiling and loading shaders.
    {
        ...
        ThrowIfFailed(D3DCompileFromFile(GetAssetFullPath(L"ComputeShaderCS.hlsl").c_str(), nullptr, nullptr, "CSMain", "cs_5_0", compileFlags, 0, &computeShader, nullptr));
...
void D3D12ComputeShader::CreateVertexBuffer()
{
...
float D3D12ComputeShader::RandomPercent()
{
    float ret = static_cast<float>((rand() % 10000) - 5000);
    return ret / 5000.0f;
}

void D3D12ComputeShader::LoadParticles(_Out_writes_(numParticles) Particle* pParticles, const XMFLOAT3& center, const XMFLOAT4& velocity, float spread, UINT numParticles)
{
    srand(0);
...
void D3D12ComputeShader::CreateParticleBuffers()
{
...
void D3D12ComputeShader::CreateAsyncContexts()
{
...
void D3D12ComputeShader::OnUpdate()
{
...
// Render the scene.
void D3D12ComputeShader::OnRender()
{
    try
    {
...
void D3D12ComputeShader::ReleaseD3DResources()
{
...
void D3D12ComputeShader::RestoreD3DResources()
{
...
void D3D12ComputeShader::WaitForGpu()
{
...
void D3D12ComputeShader::PopulateCommandList()
{
...
DWORD D3D12ComputeShader::AsyncComputeThreadProc(int threadIndex)
{
...
void D3D12ComputeShader::Simulate(UINT threadIndex)
{
    ID3D12GraphicsCommandList* pCommandList = m_computeCommandList[threadIndex].Get();
...
void D3D12ComputeShader::OnDestroy()
{
...
void D3D12ComputeShader::OnKeyDown(UINT8 key)
{
    m_camera.OnKeyDown(key);
}

void D3D12ComputeShader::OnKeyUp(UINT8 key)
{
    m_camera.OnKeyUp(key);
}

void D3D12ComputeShader::WaitForRenderContext()
{
...
void D3D12ComputeShader::MoveToNextFrame()
{
